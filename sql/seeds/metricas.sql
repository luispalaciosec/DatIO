...
('descargas',                  'Descargas',                         'conteo',     'suma',     FALSE, TRUE,  'apps'),
('actualizaciones_app',       'Actualizaciones',                   'conteo',     'suma',     FALSE, TRUE,  'apps'),
('desinstalaciones',          'Desinstalaciones',                  'conteo',     'suma',     FALSE, TRUE,  'apps'),
('dispositivos_activos',      'Dispositivos activos',              'conteo',     'ultimo',   TRUE,  TRUE,  'apps'),
('compras_in_app',            'Compras dentro de la app',          'conteo',     'suma',     FALSE, TRUE,  'apps'),
('ingresos_app',              'Ingresos de la app',                'moneda',     'suma',     FALSE, TRUE,  'apps'),
('calificaciones',            'Calificaciones recibidas',          'conteo',     'suma',     FALSE, TRUE,  'apps'),
('calificacion_promedio',     'Calificación promedio',             'conteo',     'promedio', FALSE, FALSE, 'apps'),
('fallos_app',                'Fallos (crashes)',                  'conteo',     'suma',     FALSE, TRUE,  'apps'),
('anr_app',                   'Bloqueos (ANR)',                    'conteo',     'suma',     FALSE, TRUE,  'apps'),
('vistas_maps',                'Vistas en Google Maps',             'conteo',     'suma',     FALSE, TRUE,  'negocio'),
('vistas_busqueda_negocio',    'Vistas en Búsqueda de Google',      'conteo',     'suma',     FALSE, TRUE,  'negocio'),
('llamadas',                   'Llamadas',                          'conteo',     'suma',     FALSE, TRUE,  'negocio'),
('indicaciones',               'Solicitudes de indicaciones',       'conteo',     'suma',     FALSE, TRUE,  'negocio'),
('conversaciones',             'Conversaciones (mensajes)',         'conteo',     'suma',     FALSE, TRUE,  'negocio'),
('reservas',                   'Reservas',                          'conteo',     'suma',     FALSE, TRUE,  'negocio'),
('contactos_nuevos',          'Contactos nuevos',                  'conteo',     'suma',     FALSE, TRUE,  'crm'),
('oportunidades_creadas',     'Oportunidades creadas',             'conteo',     'suma',     FALSE, TRUE,  'crm'),
('oportunidades_ganadas',     'Oportunidades ganadas',             'conteo',     'suma',     FALSE, TRUE,  'crm'),
('oportunidades_perdidas',    'Oportunidades perdidas',            'conteo',     'suma',     FALSE, TRUE,  'crm'),
('oportunidades_abiertas',    'Oportunidades abiertas',            'conteo',     'ultimo',   TRUE,  TRUE,  'crm'),
('valor_ganado',              'Valor ganado',                      'moneda',     'suma',     FALSE, TRUE,  'crm'),
('valor_pipeline',            'Valor del pipeline',                'moneda',     'ultimo',   TRUE,  TRUE,  'crm'),
...
-- App Store Connect (informes de ventas + reseñas). Claves propias del conector.
('app_store', 'descargas',               'descargas',               1),
('app_store', 'actualizaciones',         'actualizaciones_app',     1),
('app_store', 'compras_in_app',          'compras_in_app',          1),
('app_store', 'ingresos',                'ingresos_app',            1),
('app_store', 'calificaciones',          'calificaciones',          1),
('app_store', 'calificacion_promedio',   'calificacion_promedio',   1),
-- Google Play Console (CSV de Cloud Storage: installs, ratings, crashes)
('google_play', 'Daily Device Installs',   'descargas',             1),
('google_play', 'Daily Device Uninstalls', 'desinstalaciones',      1),
('google_play', 'Daily Device Upgrades',   'actualizaciones_app',   1),
('google_play', 'Active Device Installs',  'dispositivos_activos',  1),
('google_play', 'Daily Average Rating',    'calificacion_promedio', 1),
('google_play', 'Daily Crashes',           'fallos_app',            1),
('google_play', 'Daily ANRs',              'anr_app',               1),
-- CRM (PrometIO y HubSpot): agregados diarios calculados por el conector
('prometio', 'contactos_nuevos',        'contactos_nuevos',        1),
('prometio', 'oportunidades_creadas',   'oportunidades_creadas',   1),
('prometio', 'oportunidades_ganadas',   'oportunidades_ganadas',   1),
('prometio', 'oportunidades_perdidas',  'oportunidades_perdidas',  1),
('prometio', 'oportunidades_abiertas',  'oportunidades_abiertas',  1),
('prometio', 'valor_ganado',            'valor_ganado',            1),
('prometio', 'valor_pipeline',          'valor_pipeline',          1),
('hubspot', 'contactos_nuevos',         'contactos_nuevos',        1),
('hubspot', 'oportunidades_creadas',    'oportunidades_creadas',   1),
('hubspot', 'oportunidades_ganadas',    'oportunidades_ganadas',   1),
('hubspot', 'oportunidades_perdidas',   'oportunidades_perdidas',  1),
('hubspot', 'oportunidades_abiertas',   'oportunidades_abiertas',  1),
('hubspot', 'valor_ganado',             'valor_ganado',            1),
('hubspot', 'valor_pipeline',           'valor_pipeline',          1),
('zoho', 'contactos_nuevos',            'contactos_nuevos',        1),
('zoho', 'oportunidades_creadas',       'oportunidades_creadas',   1),
('zoho', 'oportunidades_ganadas',       'oportunidades_ganadas',   1),
('zoho', 'oportunidades_perdidas',      'oportunidades_perdidas',  1),
('zoho', 'oportunidades_abiertas',      'oportunidades_abiertas',  1),
('zoho', 'valor_ganado',                'valor_ganado',            1),
('zoho', 'valor_pipeline',              'valor_pipeline',          1),
-- Google Business Profile (Performance API, dailyMetrics) + reseñas
('google_negocio', 'BUSINESS_IMPRESSIONS_DESKTOP_MAPS',   'vistas_maps',             1),
('google_negocio', 'BUSINESS_IMPRESSIONS_MOBILE_MAPS',    'vistas_maps',             1),
('google_negocio', 'BUSINESS_IMPRESSIONS_DESKTOP_SEARCH', 'vistas_busqueda_negocio', 1),
('google_negocio', 'BUSINESS_IMPRESSIONS_MOBILE_SEARCH',  'vistas_busqueda_negocio', 1),
('google_negocio', 'CALL_CLICKS',                         'llamadas',                1),
('google_negocio', 'BUSINESS_DIRECTION_REQUESTS',         'indicaciones',            1),
('google_negocio', 'WEBSITE_CLICKS',                      'clics_sitio_web',         1),
('google_negocio', 'BUSINESS_CONVERSATIONS',              'conversaciones',          1),
('google_negocio', 'BUSINESS_BOOKINGS',                   'reservas',                1),
('google_negocio', 'calificaciones',                      'calificaciones',          1),
('google_negocio', 'calificacion_promedio',               'calificacion_promedio',   1)
